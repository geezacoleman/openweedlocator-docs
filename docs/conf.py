...
author = 'Guy Coleman, William Salter, and Contributors'
...
html_theme_options = {
    ...
    'light_css_variables': {
        'color-brand-primary': '#2E7D32',      # Green primary
        'color-brand-content': '#1B5E20',      # Darker green
        'font-stack': 'Inter, system-ui, sans-serif',
    },
    'dark_css_variables': {
        'color-brand-primary': '#4CAF50',      # Lighter green for dark mode
        'color-brand-content': '#81C784',      # Even lighter green
    },
    'footer_icons': [
        {
            'name': 'GitHub',
        ...
        },
        {
            ...
            'html': '<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"></path></svg>',
        },
    ],
}
